...
export const Projects: ProjectData[] = [
  ...
  {
    id: 13,
    photoURL: '/pokemon.jpg',
    name: 'Pokemon',
    description: 'Вывод покемонов Pokémon API.',
    purpose: 'SPA-приложение.',
    technologies: [
      'TypeScript',
      'React',
    ...
    repo: 'https://github.com/PolinaRomanchuk/rss_react/tree/api-queries',
    deploy: 'https://relaxed-figolla-63d514.netlify.app/',
    features: [
      'Список покемонов',
      'Поиск покемона',
      'Пагинация',
  ...
  },
  {
    ...
    description: 'Командный проект - инструмент для тестирования API.',
    purpose: 'SPA-приложение.',
    technologies: [
      'TypeScript',
      'React',
    ...
    repo: 'https://github.com/PolinaRomanchuk/rest-client-app/tree/develop',
    deploy: 'https://rest-api-async-alliance.netlify.app/',
    features: [
      'Регистрация',
      'Авторизация ',
      'Поддержка 2 языков',
      'Отправка запросов',
      'Ведение истории и аналитики запросов',
    ],
  },
];
